export default function Icon({ name, size = 24, className = '' }) {
  const paths = {
    ...
    eyeOff: <><path d="M9.9 9.9a3 3 0 0 0 4.2 4.2" /><path d="M6.3 6.3A17.9 17.9 0 0 0 2 12s4 7 10 7a10.4 10.4 0 0 0 4.2-.9M10.6 5.1A10.5 10.5 0 0 1 12 5c6 0 10 7 10 7a17.6 17.6 0 0 1-3.1 3.8" /><path d="M3 3l18 18" /></>,
